...
export async function getFarcasterManifest() {
  ...
  return {
    ...
    miniapp: {
      ...
      subtitle: "Vaquita is a Celo miniapp that gamifies saving: you deposit, grow your virtual cow, and earn rewards for staying consistent.", // 30 characters, no emojis or special characters, short description under app name
      description: "Vaquita is a Celo miniapp that gamifies saving: you deposit, grow your virtual cow, and earn rewards for staying consistent.", // 170 characters, no emojis or special characters, promotional message displayed on Mini App Page
      ...
      ogDescription: "Vaquita is a Celo miniapp that gamifies saving: you deposit, grow your virtual cow, and earn rewards for staying consistent.", // 100 characters, summarize core benefits in 1-2 lines
      screenshotUrls: [
